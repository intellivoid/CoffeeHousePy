            ...
            with timer:
                while True:
                    ...
                    if resp.status in (
                        ...
                        if r_url is None:
                            # see github.com/aio-libs/hyper_internal_service/issues/2022
                            break
                        else:
...
def request(
    ...
    auth - hyper_internal_service.helpers.BasicAuth
    ...
    Usage::
      ...
      >>> resp = await hyper_internal_service.request('GET', 'http://python.org/')
      >>> resp
